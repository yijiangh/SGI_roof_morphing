function DeformOBJ = deflection_deform_GUI(V,F,C,W)
%%%%%%%%%%
% Deform GUI with deflection plot
...
[model, u] = deflection(V, F);
%subplot(1,3,2)
% plot the original mesh
%DeformOBJ.wvsh = pdeplot(model,'XYData',u,'Zdata', u);
%axis equal;

subplot(1,2,2)
DeformOBJ.deflect = pdeplot(model,'XYData',u(:,1),'Contour','on');
axis equal;
