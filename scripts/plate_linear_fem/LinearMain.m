...
% TODO
% fixed support, translational dof only
% triangular elements
...
[coordinates, nodes] = MeshRectanglularPlate(a,b,Nx,Ny,loadstep) ; 
% for node connectivity counting starts from 1 towards +y axis and new row again start at y=0. see pdf for more details.
...
D_pb= E/(1-nu*nu)*[1  nu 0; 
                   nu  1  0; 
                   0  0  (1-nu)/2];  % material matrix for bending
%
%  For shear stiffness
%
